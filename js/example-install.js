var
    ...
    copyFiles = [{
      from: 'bower_components/viking_base/example.gitignore',
      to: '.gitignore'
    }, {
      from: 'bower_components/viking_base/example-index.html',
      to: 'index.html'
    }, {
      from: 'bower_components/viking_base/example-pom.xml',
      to: 'pom.xml'
    }, {
      from: 'bower_components/viking_base/example-robots.txt',
      to: 'robots.txt'
    }, {
      from: 'bower_components/viking_base/css/example-style.scss',
      to: 'css/style.scss'
    }, {
      from: 'bower_components/viking_base/img/example-apple-touch-icon-57x57-precomposed.png',
      to: 'img/apple-touch-icon-57x57-precomposed.png'
    }, {
      from: 'bower_components/viking_base/img/example-apple-touch-icon-72x72-precomposed.png',
      to: 'img/apple-touch-icon-72x72-precomposed.png'
    }, {
      from: 'bower_components/viking_base/img/example-apple-touch-icon-114x114-precomposed.png',
      to: 'img/apple-touch-icon-114x114-precomposed.png'
    }, {
      from: 'bower_components/viking_base/img/example-apple-touch-icon-144x144-precomposed.png',
      to: 'img/apple-touch-icon-144x144-precomposed.png'
    }, {
      from: 'bower_components/viking_base/img/example-apple-touch-icon-precomposed.png',
      to: 'img/apple-touch-icon-precomposed.png'
    }, {
      from: 'bower_components/viking_base/img/example-apple-touch-icon.png',
      to: 'img/apple-touch-icon.png'
    }, {
      from: 'bower_components/viking_base/img/example-favicon.ico',
      to: 'img/favicon.ico'
    }, {
      from: 'bower_components/viking_base/js/example-main.js',
      to: 'js/main.js'
    }, {
      from: 'bower_components/viking_base/js/example-templates/example-application.hbs',
