...
module.exports = {
   ...
   */
  preprocessJsVendorCb: function( block ) {
    ...
    block
      ...
      .pipe( this.gulp.dest( this.output.publish + this.output.jsVendor + filename ) );
  },
  ...
  replaceJsSources: function( sources, vendor ) {
    ...
    for ( ; i < sources.length; i++ ) {
      ...
      if (pathSegments.indexOf('jquery-1x') !== -1) {
        ...
        pathSegments[ pathSegments.length - 1 ] = 'jquery-1x.js';
      }
      ...
      cb: function() {
        ...
        return this.gulp.src( this.sources.html )
          .pipe( this.plugins.htmlbuild({
            ...
            // Process jQuery 1x
            jqueryonex: this.plugins.htmlbuild.preprocess.js( this.preprocessJsVendorCb.bind( this, this.output.jquery1x ) ),

            // Process vendor scripts. Set output paths.
            jsvendor: this.plugins.htmlbuild.preprocess.js( this.preprocessJsVendorCb.bind( this ) )
          }))
